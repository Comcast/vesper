...
# Install Stable Go
WORKDIR /opt
RUN curl -O https://storage.googleapis.com/golang/go1.10.2.linux-amd64.tar.gz && tar -C /usr/local -xzf /opt/go1.10.2.linux-amd64.tar.gz
...
RUN git clone -b v2.3 git@github.com:iris-platform/vesper.git
