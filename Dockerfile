...
# Install Stable Go
WORKDIR /opt
RUN curl -O https://storage.googleapis.com/golang/go1.11.4.linux-amd64.tar.gz && tar -C /usr/local -xzf /opt/go1.11.4.linux-amd64.tar.gz
...
RUN git clone -b v2.7 git@github.com:iris-platform/vesper.git
